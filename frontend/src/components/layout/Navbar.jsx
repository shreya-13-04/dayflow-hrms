    ...
    <header className="h-13 bg-white/90 border-b border-stone-200/80 sticky top-0 z-30 backdrop-blur-xs px-4 sm:px-6 flex items-center justify-between">
      ...
      <div className="flex items-center space-x-2 sm:space-x-3">
        ...
        <button 
          ...
          className="flex items-center space-x-1 px-2.5 py-1 text-xs font-medium text-stone-700 hover:text-stone-950 bg-stone-100 hover:bg-stone-200/70 rounded-md transition-colors border border-stone-200/60 cursor-pointer"
        >
